...
function findFirstDuplicateSum(
  _$staropt$star,
  _$staropt$star$1,
  _$staropt$star$2,
  list
  ...
  while (true) {
    ...
    if (remaining) {
      ...
      if (match) {
        ...
        _$staropt$star = Caml_option.some(
          Curry._2(Utils$Aoc2018.IntSet[/* add */ 3], nextSum, sums)
        )
        continue
      }
    } else {
...
function solve2(param) {
  var frequencies = Utils$Aoc2018.inputFileToList(day1Input)
  return findFirstDuplicateSum(
    undefined,
    undefined,
    undefined,
    List.map(Caml_format.caml_int_of_string, frequencies)
  )
}

function generateSumsStream(frequencies) {
  return Utils$Aoc2018.Stream[/* scanLeft */ 4](
    function(prim, prim$1) {
      return (prim + prim$1) | 0
    },
    0,
    Utils$Aoc2018.Stream[/* cycle */ 3](
      Utils$Aoc2018.Stream[/* ofList */ 2](frequencies)
    )
  )
}
...
function solve2Streams(param) {
  ...
  return findFirstDuplicate(
    generateSumsStream(List.map(Caml_format.caml_int_of_string, frequencies))
  )
}
