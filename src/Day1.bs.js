...
var inputFile = "src/day1-input.txt";
...
function solve1(param) {
  var frequencies = Utils$Aoc2018.inputFileToList(inputFile);
...
function generateSumsStream(frequencies) {
  return Utils$Aoc2018.Stream[/* scanLeft */4]((function (prim, prim$1) {
                return prim + prim$1 | 0;
              }), 0, Utils$Aoc2018.Stream[/* cycle */3](Utils$Aoc2018.Stream[/* ofList */2](frequencies)));
}
